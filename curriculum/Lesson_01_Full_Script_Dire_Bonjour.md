...
Two voices, one pipeline:

- **NARRATOR (EN)** — the English host. Warm, encouraging, explains what's happening and why. Route every NARRATOR line to your English ElevenLabs voice.
- **FRENCH VOICE (FR)** — the model voice. Every word, phrase, and sentence the learner is meant to say comes from this voice, and only this voice, so learners always hear real, native-modeled French — never English-accented French. Route every FRENCH VOICE line to your French ElevenLabs voice.
...
**NARRATOR (EN)** *[encouraging, a little playful]*
...
**FRENCH VOICE (FR)** *[pleased, warm]*
"Bonjour. Voilà."

**NARRATOR (EN)** *[encouraging]*
...
**FRENCH VOICE (FR)** *[light, friendly]*
"Salut… salut."
...
**FRENCH VOICE (FR)** *[clear, natural pace]*
"S'il vous plaît."
...
**FRENCH VOICE (FR)** *[warm, encouraging]*
"Bonjour, madame. Merci !"
...
**FRENCH VOICE (FR)** *[gentle, inviting]*
"À toi. Dix secondes."
...
**FRENCH VOICE (FR)** *[quick, apologetic]*
"Pardon !"
...
**NARRATOR (EN)** *[warm, a little wistful]*
...
**FRENCH VOICE (FR)** *[warm, steady, unhurried]*
...
**NARRATOR (EN)** *[excited, warm, celebratory]*
